...
function setup(){
    ...
    box7 = new Box(555,100,30,30);
    box8 = new Box(585,100,30,30);
    box9 = new Box(615,100,30,30);
    box10= new Box(645,100,30,30);
    
    box11 = new Box(585,50,30,30);
    box12= new Box(615,50,30,30);
    ...
    box19 = new Box(955,200,30,30);
    box20 = new Box(985,200,30,30);
    box21 = new Box(1015,200,30,30);
    box22= new Box(1045,200,30,30);
    
    box23 = new Box(985,150,30,30);
    box24= new Box(1015,150,30,30);
